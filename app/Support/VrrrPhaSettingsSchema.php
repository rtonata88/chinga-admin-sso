    ...
    public static function definition(): array
    {
        return [
            ...
            'required' => [
                ...
                'growth_rate_k', 'tick_interval_ms', 'auto_cashout_enabled',
            ],
            'properties' => [
                ...
                'max_multiplier' => ['type' => 'integer', 'title' => 'Max multiplier', 'description' => 'Tail truncation of the crash point', 'minimum' => 2, 'maximum' => 1000000, 'default' => 10000, 'x-group' => 'game', 'x-tenant-overridable' => false],
