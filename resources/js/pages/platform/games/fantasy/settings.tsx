...
export default function Settings({ game, tenants }: Props) {
    ...
    const handleSaveGlobal = () => {
        ...
        router.put('/platform/games/fantasy/settings/global', globalSettings as unknown as Record<string, string>, {
    ...
    const handleSaveTenant = (tenantUuid: string) => {
        ...
        router.put(`/platform/games/fantasy/settings/tenant/${tenantUuid}`, payload as unknown as Record<string, string>, {
