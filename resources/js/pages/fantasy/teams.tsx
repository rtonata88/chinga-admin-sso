...
export default function Teams({ teams, filters }: Props) {
    ...
    const handleSearch = () => {
        router.get('/fantasy/teams', { search: search || undefined }, { preserveState: true });
    };
                            ...
                            >
                                ...
                                <div className="flex gap-2">
                                    <Button
                                        ...
                                        onClick={() => router.get('/fantasy/teams', { ...filters, page: teams.current_page - 1 }, { preserveState: true })}
                                    />
                                    <Button
                                        label="Next"
